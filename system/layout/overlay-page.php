...
<?php if (!$registration->registration_successful && !$registration->verification_successful) { ?>	
	<form id="sign-up-form">
		...
		<input placeholder="Name" type="text" name="sign-up-name" id="sign-up-name" 
           ...
           onchange="this.setCustomValidity('')" pattern="[a-zA-Z ]{6,64}" required />
		<input placeholder="Phone" type="text" name="sign-up-phone" id="sign-up-phone" pattern="[0-9]{6,64}" required />
